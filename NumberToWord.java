...
class NumberToWord   
{  
	//user-defined static function that converts a number into respective words  
	static void numberToWords(char num[])  
	{  
	//determines the number of digits in the given number  
	int len = num.length;  
	//checks the given has length zero 
	if (len == 0)   
	{  
	...
	//here,I have specified the length of the number to 4  
	//it means that the number which you want to converts should be four or less than four digits  
	if (len > 4)   
	{  
	...
	//string type array of multiples of tens   
...
//main() method  
	...
	{  
		//calling the user-defined method and that invokes another predefined function toCharArray()  
